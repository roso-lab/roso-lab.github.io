...
<h1 class="titleHighlight is-h1 anim-fade-up">Most recent news</h1>
<div class="grid-container">
    <div class="go212694760 container anim-fade-up stagger-1">
    ...
    <div class="go212694760 container anim-fade-up stagger-2">
        <div class="two-columns2">
            <div class="column">
                <div class="text-section">
                    <h2 class="is-h2 titleHighlight">November 2022</h2>
                    <div class="is-p">Katie Winkle was granted the <span class="titleHighlight">Jacobs Foundation Research Fellowship</span>!</div>
                    <div>
...
<h1 class="is-h1 titleHighlight anim-fade-up">Most recent publications</h1>
{% include feature_row_publications id = "feature_row_publications" type="center-small" %}
</section>

<!-- People -- DARK SECTION -->
<div class="section-dark">
<h1 class="is-h1 titleHighlight anim-fade-up">People</h1>
...
<!-- Visiting Address -->
<h1 class="is-h1 titleHighlight anim-fade-up">Visiting address</h1>
